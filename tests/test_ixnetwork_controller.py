...
from shellfoundry_traffic.test_helpers import create_session_from_config, TestHelpers, skip_if_offline
...
class TestIxNetworkControllerShell:
    ...
    def test_session_id(self, session: CloudShellAPISession, context: ResourceCommandContext) -> None:
        ...
        globals = session.ExecuteCommand(get_reservation_id(context), ALIAS, "Service", "get_children", cmd_inputs)
